...
def build_agent(agent, batch_size,environment,num_states_automaton,
                ...
                non_markovian = False, entropy_regularization = 0.0, saver = None):
    ...
    Args:
        ...
        environment: (tensorforce.environments.Environment) istance of the tensorforce environment in which is trained.
